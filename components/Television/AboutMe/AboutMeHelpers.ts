...
export function drawPlayStopButton(
    ...
    const v0 = { x: triV0.x * (1 - m) + sqV0.x * m, y: triV0.y * (1 - m) + sqV0.y * m };
    const v1 = { x: triV1.x * (1 - m) + sqV1.x * m, y: triV1.y * (1 - m) + sqV1.y * m };
    const v2 = { x: triV2.x * (1 - m) + sqV2.x * m, y: triV2.y * (1 - m) + sqV2.y * m };
    const v3 = { x: triV0.x * (1 - m) + sqV3.x * m, y: triV0.y * (1 - m) + sqV3.y * m };
    ...
    if (m < 0.5) {
        ...
        ctx.bezierCurveTo(cx + v0.x + t0.x * (1 - m * 2), cy + v0.y + t0.y * (1 - m * 2), cx + v1.x - t1.x * (1 - m * 2), cy + v1.y - t1.y * (1 - m * 2), cx + v1.x, cy + v1.y);
        ctx.bezierCurveTo(cx + v1.x + t1.x * (1 - m * 2), cy + v1.y + t1.y * (1 - m * 2), cx + v2.x - t2.x * (1 - m * 2), cy + v2.y - t2.y * (1 - m * 2), cx + v2.x, cy + v2.y);
        ctx.bezierCurveTo(cx + v2.x + t2.x * (1 - m * 2), cy + v2.y + t2.y * (1 - m * 2), cx + v0.x - t0.x * (1 - m * 2), cy + v0.y - t0.y * (1 - m * 2), cx + v0.x, cy + v0.y);
    } else {
